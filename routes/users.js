...
routes.get(
  "/:user_id/followings-lives",
  [
    validateParams(getFollowingsLivesUserSchema, "params"),
    validateParams(getFollowingsLivesUserSchema, "query"),
  ],
  usersController.getFollowingsLivesUser
);
