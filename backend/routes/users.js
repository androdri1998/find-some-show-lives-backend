...
const { createUserSchema, authenticateUserSchema, getUserSchema, getUsersSchema } = require('../app/schemas/users.schema');
...
routes.get('/', validateParams(getUsersSchema, 'query'), usersController.getUsers);
